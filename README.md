...
**ai-edit** is a local-first, safe, and controlled AI-assisted code editing tool for developers who care about security, context, and reliability.

## 🚀 Vision

AI-powered coding tools are powerful, but often unsafe or privacy-invasive. `ai-edit` aims to solve this by being:
...
- **Undo Support**: One-command rollback (`ai-edit --undo`).
...
### Editing Code
Ask `ai-edit` to perform a task on a specific file:
```bash
